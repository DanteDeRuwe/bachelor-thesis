...
tackling the challenges and the limitations that go along with this on its way.
...
recompilation of the entire application, and mixing different technologies
across frontends is not possible. Also, upon startup, all libraries have to be
loaded, which makes this approach sub-optimal regarding scalability.
