...
As software project grow larger and larger in size, naturally more developers
are needed to maintain them. But the effici\"ency of teams does not scale
...
makes sure that experts can co-opertate together as one team and ensure a high
technical standard within the boundaries of their respective areas of expertise.

But what if a company wants to put focus on user experience, innovation and
features, in stead of purely on creating the most technically perfect solution?
This is where multidisciplinar or cross-funtional ``feature teams'' can come in,
which are grouped around a specific business case or customer need. This
``vertical slicing'' has major benefits: it enables teams to be completely
independent and have end-to-end responsibility of the features they have to
develop. This aids in accelerating development speed, cutting down on intra-team
...
The ``micro frontends'' architecture give developers the necessary tools to be
