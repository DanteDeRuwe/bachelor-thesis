...
\hrefself{https://github.com/lauchacarro/MicroFrontend-Blazor-React}}, this is not
within the scope of this thesis.

The desired solution, in contrast to the aforementioned approaches, has run-time
