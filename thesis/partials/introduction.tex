...
focus on the Blazor\hreffootnote{https://blazor.net}
\gls{wasm}\hreffootnote{https://webassembly.org} framework.
...
\begin{itemize}
  ...
  \item[$RQ_2$] How to render Blazor-based \glsplural{microfrontend} with the
