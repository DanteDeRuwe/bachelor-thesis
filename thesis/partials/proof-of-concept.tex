...
There also is an \gls{appshell} where these \glsplural{microfrontend} will get
integrated into. This will be discussed further in \fullref{sec:poc-development}.
