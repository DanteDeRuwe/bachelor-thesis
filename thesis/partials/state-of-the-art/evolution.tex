...
reduces development speed, as well as agility. Monoliths can also be considered
...
one of the most common ways is via a (RESTful) API.
...
\begin{itemize}
    ...
    While a monolith had to be deployed as one big program, teams could now
